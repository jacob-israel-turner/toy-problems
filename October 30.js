...
//the indexOf runs a for loop itself.  So, as the original array increases, the time to execute the function increases exponentially (n^n, where n === arr.length)
//to avoid that, save the item to an object.  A look up on an object is called static data, or static lookup, or something like that.  It virtually takes no time.


//This solution is from Tyle McGinnis
