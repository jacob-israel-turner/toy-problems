//create a function that takes an array of strings as an argument and returns an object that contains 
//the strings converted to base 64 as keys and the length of the original strings as values. Each string should only be encoded once!
